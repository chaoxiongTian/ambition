...
fun Uri.toRealFile(context: Context): File? {
    ...
    if (ContentResolver.SCHEME_FILE == scheme) {
    ...
    } else if (fromKitKat() && DocumentsContract.isDocumentUri(context, this)) {
        if ("com.android.externalstorage.documents" == authority) {
            ...
            if ("primary".equals(type, ignoreCase = true)) {
                ...
                val mStorageManager = context.storageManager
                try {
            ...
            if (!TextUtils.isEmpty(id)) {
                try {
                    ...
                    return context.getFileFromUri(contentUri, "1_1")
            ...
            return context.getFileFromUri(contentUri, selection, selectionArgs)
        } else if (ContentResolver.SCHEME_CONTENT == scheme) {
            return context.getFileFromUri(this)
        } else {
            return null
        }
